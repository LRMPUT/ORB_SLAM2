...
for seq, yaml in zip(sequences, yamls):
    ...
    print('./Examples/Stereo/stereo_kitti Vocabulary/ORBvoc.txt Examples/Stereo/' + str(yaml) + ' ' + str(mainDatasetPath) +'/' + str(seq) +'/');

    # Run code
    call('./Examples/Stereo/stereo_kitti Vocabulary/ORBvoc.txt Examples/Stereo/' + str(yaml) + ' ' + str(mainDatasetPath) +'/' + str(seq) +'/', shell=True);
